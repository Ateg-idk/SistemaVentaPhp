...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Nombre <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="producto_nombre" value="<?php echo $datos['producto_nombre']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,800}" maxlength="800" required>
				</div>
		  	</div>
		</div>
		...
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Ubicación <?php echo CAMPO_OBLIGATORIO; ?></label>
					<input class="input" type="text" name="producto_ubicacion" value="<?php echo $datos['producto_ubicacion']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,100}" maxlength="100" required>
				</div>
		  	</div>
		</div>
