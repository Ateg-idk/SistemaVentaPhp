...
<div class="container pb-6 pt-6">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Nombre <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="producto_nombre" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,800}" maxlength="800" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
    ...
    <div class="column">
        <div class="control">
            ...
            <input class="input" type="text" name="producto_ubicacion" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,100}" maxlength="100" required>
        </div>
    </div>
</div>
